...
const PATIENT_NAV: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect width="18" height="14" x="3" y="5" rx="2"/><path d="M3 10l0-4"/><path d="M21 10l0-4"/><path d="M3 14l8-4 8 4"/>
      </svg>
    ),
    roles: ['patient'],
  },
...
const CLINICIAN_NAV: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d='M3 7V5a2 2 0 0 1 2-2h2'/><path d='M17 3h2a2 2 0 0 1 2 2v2'/><path d='M21 17v2a2 2 0 0 1-2 2h-2'/><path d='M7 21H5a2 2 0 0 1-2-2v-2'/><rect width='8' height='8' x='7' y='7' rx='1'/>
      </svg>
    ),
    roles: ['clinician'],
  },
...
const CHW_NAV: NavItem[] = [
  ...
  },
  {
    ...
    roles: ['chw', 'patient', 'clinician', 'admin'],
  },
];
...
const ADMIN_NAV: NavItem[] = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 12a9 9 0 0 1-9 9m9-9a9 9 0 0 0-9-9m9 9H3m9 9a3 3 0 0 1-3-3m3 3a3 3 0 0 0 3-3"/>
      </svg>
    ),
    roles: ['admin'],
  },
